...
exts = [Extension('roc_auc_pairwise.utils',
        ...
        sources = ['roc_auc_pairwise/sigmoid_pairwise_gpu.pyx', 'src/cuda/sigmoid_pairwise_kernels.cu', 'src/cuda/sigmoid_pairwise.cu'],
        library_dirs = [CUDA['lib64']],
        libraries = ['cudart'],
        language = 'c++',
        runtime_library_dirs = [CUDA['lib64']],
        ...
        sources = ['roc_auc_pairwise/sigmoid_pairwise_auc_gpu.pyx', 'src/cuda/sigmoid_pairwise_auc_kernels.cu', 'src/cuda/sigmoid_pairwise_auc.cu', 'src/cuda/deltaauc.cu', 'src/cpu/utils.cpp'],
        library_dirs = [CUDA['lib64']],
        libraries = ['cudart'],
        language = 'c++',
        runtime_library_dirs = [CUDA['lib64']],
