...
def test_sigmoid_pairwise_loss_auc_cpu_py_unique_8():
    ...
    for i in tqdm(range(df.shape[0])):
        ...
        sigm_loss_ = sigmoid_pairwise_loss_auc_cpu_py(y_true, y_pred)
...
def test_sigmoid_pairwise_loss_auc_exact_cpu_py_unique_8():
    ...
    for i in tqdm(range(df.shape[0])):
        ...
        sigm_loss_ = sigmoid_pairwise_loss_auc_exact_cpu_py(y_true, y_pred)
...
def test_sigmoid_pairwise_diff_hess_auc_cpu_unique_8_parquet():
    ...
    for i in tqdm(range(df.shape[0])):
        ...
        grad, hess = sigmoid_pairwise_diff_hess_auc_cpu_py(y_true, y_pred)
...
def test_sigmoid_pairwise_diff_hess_auc_exact_cpu_unique_8_parquet():
    ...
    for i in tqdm(range(df.shape[0])):
        ...
        grad, hess = sigmoid_pairwise_diff_hess_auc_exact_cpu_py(y_true, y_pred)
